...
// // TryOn.jsx
// // Updated: reads { frameId, productId, productName } from React Router location.state.
// // The matching frame is auto-selected and scrolled into view on mount.
// // All camera / face-mesh logic is untouched.
...
// // ---------------------------------------------------------------------------
// // GLASS_OPTIONS – single source of truth for ALL frames.
// // Each frame CAN have an optional `productIds: [1, 5, 12]` array so that
// // multiple products share one frame, or use `frameId` in your JSON data
// // to point to the exact glass id ("/glassN.png").
// // ---------------------------------------------------------------------------
// const GLASS_OPTIONS = [
//    { id: "/glass1.png", name: "T04917 - Square Plastic Sunglass Luxury Style", price: "PKR 2,999", emoji: "👓", sizes: [{ label: "XL", scale: 1.10, mobileScale: 1.00 }] },
//   { id: "/glass2.png", name: "K01 - Oval Plastic Sunglass", price: "PKR 800", emoji: "🕶️", sizes: [{ label: "L", scale: 1.15, mobileScale: 1.00 }] },
//   { id: "/glass3.png", name: "D403054S - Square Plastic Sunglass", price: "PKR 2,400", emoji: "🥽", sizes: [{ label: "L", scale: 1.15, mobileScale: 1.00 }] },
//   { id: "/glass4.png", name: "20237 - Square Shape Plastic Sunglass", price: "PKR 800", emoji: "⭕", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass5.png", name: "RB4455F - Square Plastic Sunglass", price: "PKR 2,500", emoji: "🕶️", sizes: [{ label: "L", scale: 1.25, mobileScale: 0.98 }] },
//   { id: "/glass6.png", name: "5013 - Square Plastic Shape Sunglass", price: "PKR 2,400", emoji: "🪩", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass7.png", name: "S2160 - Square Plastic Sunglass", price: "PKR 1,899", emoji: "🔲", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.10 }] },
//   { id: "/glass8.png", name: "3377 - Plastic Eye Sunglass", price: "PKR 1,600", emoji: "😼", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.10 }] },
//   { id: "/glass9.png", name: "28044 - Square Plastic Sunglass", price: "PKR 2,899", emoji: "🛡️", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.75 }] },
//   { id: "/glass10.png", name: "99032 - Eye Plastic Sunglass", price: "PKR 4,200", emoji: "🥚", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass11.png", name: "T1798 - Square Plastic Sunglass", price: "PKR 2,400", emoji: "⬛", sizes: [{ label: "S", scale: 0.75, mobileScale: 0.50 }] },
//   { id: "/glass12.png", name: "28118 - Eye Plastic Sunglass", price: "PKR 3,200", emoji: "⬡", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass13.png", name: "IPB - One Piece Sunglass", price: "PKR 800", emoji: "🔷", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.75 }] },
//   { id: "/glass14.png", name: "F0493 - Plastic Square Men Sunglass", price: "PKR 4,600", emoji: "⚙️", sizes: [{ label: "S", scale: 0.95, mobileScale: 0.50 }] },
//   { id: "/glass15.png", name: "BL0985 - Square Plastic Sunglass", price: "PKR 3,200", emoji: "🏃", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass16.png", name: "D7481 - Box Plastic Sunglass", price: "PKR 4,800", emoji: "🎞️", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass17.png", name: "H077048 - Box Plastic Sunglass", price: "PKR 4,600", emoji: "✨", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass18.png", name: "9702 - Metal Oval", price: "PKR 1,499", emoji: "💎", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass19.png", name: "JV5816 - Plastic Curve Square Shape", price: "PKR 1,399", emoji: "🎨", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass20.png", name: "D8822 - Plastic Square Shape", price: "PKR 1,199", emoji: "Glasses", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.95 }] },
//   { id: "/glass21.png", name: "PS8035 - Plastic Square Shape", price: "PKR 1,399", emoji: "Glasses", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.75 }] },
...
// const resolveInitialFrame = (locationState) => {
//   if (!locationState?.frameId) return GLASS_OPTIONS[0].id;
//   const match = GLASS_OPTIONS.find(g => g.id === locationState.frameId);
...
// class FaceGeoSmoother {
//   constructor({ posAlpha, scaleAlpha, rotAlpha, maxPosDelta = 60, maxScaleDelta = 0.15 }) {
//     this.posAlpha = posAlpha; this.scaleAlpha = scaleAlpha; this.rotAlpha = rotAlpha;
//     this.maxPosDelta = maxPosDelta; this.maxScaleDelta = maxScaleDelta; this.prev = null;
//   }
//   _step(prev, cur, alpha, maxDelta, deadzone = 0) {
//     const raw = cur - prev;
//     if (deadzone > 0 && Math.abs(raw) < deadzone) return prev;
//     return prev + alpha * Math.max(-maxDelta, Math.min(maxDelta, raw));
//   }
//   smooth(cur, deadzone = 0) {
//     if (!this.prev) { this.prev = { ...cur }; return { ...cur }; }
//     const p = this.prev;
...
//     rightIris = px(LANDMARKS.RIGHT_IRIS_CENTER);
//   } else {
//     leftIris  = { x: (leftEyeOut.x  + leftEyeIn.x)  / 2, y: (leftEyeOut.y  + leftEyeIn.y)  / 2, z: 0 };
//     rightIris = { x: (rightEyeOut.x + rightEyeIn.x) / 2, y: (rightEyeOut.y + rightEyeIn.y) / 2, z: 0 };
//   }
...
//   const angleEyeCorners = Math.atan2(rightEyeOut.y - leftEyeOut.y, rightEyeOut.x - leftEyeOut.x);
//   const angleBrow       = Math.atan2(rightBrowLower.y - leftBrowLower.y, rightBrowLower.x - leftBrowLower.x);
//   const angleIris       = useIris ? Math.atan2(rightIris.y - leftIris.y, rightIris.x - leftIris.x) : angleEyeCorners;
//   const angle           = angleEyeCorners * 0.65 + angleBrow * 0.25 + angleIris * 0.10;
...
// // ─── BrandingBadge ────────────────────────────────────────────────────────────
// const BrandingBadge = ({ mobile }) => (
//   <div aria-label="Product by ASW Solution" style={{
//     position: "absolute", top: mobile ? 92 : 18, left: "50%", transform: "translateX(-50%)",
//     zIndex: 100, display: "flex", alignItems: "center", gap: 8,
//     padding: mobile ? "6px 16px" : "8px 20px", borderRadius: 999,
//     background: mobile ? "rgba(0,0,0,0.35)" : "rgba(254,253,223,0.65)",
...
//   }}>
//     <div aria-hidden="true" style={{ width:7, height:7, borderRadius:"50%", background:"#22c55e", boxShadow:"0 0 10px #22c55e,0 0 4px rgba(34,197,94,0.60)", animation:"pulse 2s ease infinite", flexShrink:0 }} />
//     <span style={{ fontFamily:"'Outfit',sans-serif", fontSize: mobile?11:13, fontWeight:700, letterSpacing:"2px", color: mobile?"#ffffff":"#1E293B", textTransform:"uppercase", userSelect:"none" }}>
//       PRODUCT BY ASW SOLUTION
//     </span>
//   </div>
// );
...
//   const [open, setOpen] = useState(defaultOpen);
//   return (
//     <div style={{ borderRadius:16, border:`1px solid ${C.glassBorder}`, overflow:"hidden", background:C.glassBg, backdropFilter:"blur(12px)", WebkitBackdropFilter:"blur(12px)", boxShadow:`0 2px 8px ${C.text06}` }}>
//       <button onClick={() => setOpen(o => !o)} aria-expanded={open} aria-label={`${open?"Collapse":"Expand"} ${title}`} style={{ width:"100%", display:"flex", alignItems:"center", justifyContent:"space-between", padding:"13px 16px", background:"rgba(254,253,223,0.50)", border:"none", cursor:"pointer", borderBottom: open?`1px solid ${C.glassBorder}`:"none" }}>
//         <span style={{ display:"flex", alignItems:"center", gap:8, fontSize:10, fontWeight:700, letterSpacing:"2px", color:C.primary }}>
//           <span style={{ fontSize:13 }} aria-hidden="true">{icon}</span>{title}
//         </span>
...
//     <div style={{ display:"flex", justifyContent:"space-between", marginBottom:7 }}>
//       <label style={{ fontSize:10, color:C.text55, fontWeight:600, letterSpacing:"1px" }}>{label}</label>
//       <span style={{ fontSize:11, fontWeight:700, background:C.gradPrimaryTx, WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>{fmt(value)}</span>
//     </div>
//     <input type="range" min={min} max={max} step={step} value={value} aria-label={label} onChange={e => onChange(Number(e.target.value))} style={{ width:"100%", height:3, background:C.primary20, borderRadius:4, appearance:"none", WebkitAppearance:"none", cursor:"pointer" }} />
//   </div>
// );

// // ─────────────────────────────────────────────────────────────────────────────
// // TryOn – main component
// // ─────────────────────────────────────────────────────────────────────────────
// const TryOn = () => {
//   // ── Read router state ───────────────────────────────────────────────────
//   const location = useLocation();

//   // Determine initial frame ONCE from router state (no re-derive on rerenders)
//   const initialFrameId = resolveInitialFrame(location.state);
//   const incomingProductName = location.state?.productName || null;

//   // Refs for camera/rendering (unchanged from original)
//   const videoRef            = useRef(null);
//   const canvasRef           = useRef(null);
//   const imgRef              = useRef(new Image());
//   const rafIdRef            = useRef(null);
...
//   const touchStartY         = useRef(null);
//   const cameraRdyRef        = useRef(false);
//   const glassesRef          = useRef(initialFrameId);   // ← initialized with incoming frame
//   const adjRef              = useRef({});
//   const pendingResultRef    = useRef(null);
//   const camStreamRef        = useRef(null);
//   const camInstanceRef      = useRef(null);
...
//   // Ref for the active carousel item so we can scroll it into view
//   const activeCarouselItemRef = useRef(null);
//   // Ref for the desktop grid item
//   const activeGridItemRef     = useRef(null);
...
//   // State – initialised with the incoming frame
...
//   const setAdj = useCallback((key, val) => {
//     const id = glassesRef.current;
//     adjustmentsRef.current = { ...adjustmentsRef.current, [id]: { ...(adjustmentsRef.current[id] || DEFAULT_ADJ), [key]: val } };
//     adjRef.current = adjustmentsRef.current;
//     setAdjUIState(prev => ({ ...prev, [key]: val }));
//   }, []);
...
//   const resetAdj = useCallback(() => {
//     const id = glassesRef.current;
//     const defaults = id === "/glass2.png" ? { ...AVIATOR_ADJ } : id === "/glass4.png" ? { ...ROUND_ADJ } : { ...DEFAULT_ADJ };
//     adjustmentsRef.current = { ...adjustmentsRef.current, [id]: defaults };
//     adjRef.current = adjustmentsRef.current;
//     setAdjUIState({ ...defaults });
//   }, []);
...
//   // ── Scroll active item into view on mount and on glasses change ──────────
//   useEffect(() => {
//     // Mobile carousel
//     if (activeCarouselItemRef.current) {
//       activeCarouselItemRef.current.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" });
//     }
//     // Desktop grid
//     if (activeGridItemRef.current) {
//       activeGridItemRef.current.scrollIntoView({ behavior: "smooth", block: "nearest" });
//     }
//   }, [glasses]);
...
//     const canvas = canvasRef.current;
//     if (!canvas) return;
//     if (!ctxRef.current) ctxRef.current = canvas.getContext("2d", { alpha: false, willReadFrequently: false });
//     const ctx = ctxRef.current;
//     if (!ctx) return;
...
//     const W = canvas.width, H = canvas.height;
//     const userB = brightnessRef.current, userC = contrastRef.current, userS = saturateRef.current;
//     const needsFilter = !mobile && (userB !== 100 || userC !== 100 || userS !== 100 || BEAUTY_B !== 100 || BEAUTY_C !== 100 || BEAUTY_S !== 100);
//     ctx.filter = needsFilter ? `brightness(${BEAUTY_B}%) contrast(${BEAUTY_C}%) saturate(${BEAUTY_S}%) brightness(${userB}%) contrast(${userC}%) saturate(${userS}%)` : "none";
//     ctx.save(); ctx.translate(W, 0); ctx.scale(-1, 1); ctx.drawImage(result.image, 0, 0, W, H); ctx.restore();
//     ctx.filter = "none";

//     if (!result.multiFaceLandmarks?.length) { smootherRef.current.reset(); lastDrawnVersionRef.current = resultVersionRef.current; return; }
...
//     const img = imgRef.current;
//     if (!img.complete || !img.naturalWidth) { lastDrawnVersionRef.current = resultVersionRef.current; return; }
...
//     }
//     const mobile   = isMobileRef.current;
//     const faceMesh = new window.FaceMesh({ locateFile: f => `https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh@0.4/${f}` });
//     faceMesh.setOptions({
//       maxNumFaces: 1, refineLandmarks: !mobile,
//       minDetectionConfidence: mobile ? 0.40 : 0.50,
//       minTrackingConfidence:  mobile ? 0.35 : 0.50,
//     });
//     faceMesh.onResults(onResults);
...
//     navigator.mediaDevices.getUserMedia({
//       video: { facingMode:"user", width: mobile?{ideal:640}:{ideal:DESKTOP_CAM_W}, height: mobile?{ideal:480}:{ideal:DESKTOP_CAM_H}, frameRate:{ideal: mobile?30:60} },
//       audio: false,
//     })
//       .then(stream => {
//         camStreamRef.current = stream;
...
//               if (canvasRef.current && vw && vh) { canvasRef.current.width=vw; canvasRef.current.height=vh; setVideoDims({w:vw,h:vh}); ctxRef.current=null; }
//             } else {
//               if (canvasRef.current) { canvasRef.current.width=DESKTOP_CANVAS_W; canvasRef.current.height=DESKTOP_CANVAS_H; ctxRef.current=null; }
//             }
//             const sendFrame = async () => {
//               if (!cameraRdyRef.current) return;
//               try { if (video.readyState >= 2) await faceMesh.send({ image: video }); } catch (_) {}
//               if (cameraRdyRef.current) camInstanceRef.current = requestAnimationFrame(sendFrame);
//             };
//             camInstanceRef.current = requestAnimationFrame(sendFrame);
//           }).catch(() => setMpError("Could not start video playback. Please reload and allow camera access."));
//         };
//       })
//       .catch(() => setMpError("Camera access denied or not available. Please allow camera permissions and reload."));
...
//     *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
//     input[type="range"]{-webkit-appearance:none;appearance:none;background:transparent;}
//     input[type="range"]::-webkit-slider-runnable-track{background:linear-gradient(90deg,rgba(232,127,36,0.30),rgba(232,127,36,0.10));height:3px;border-radius:3px;}
//     input[type="range"]::-webkit-slider-thumb{-webkit-appearance:none;width:16px;height:16px;border-radius:50%;background:radial-gradient(circle at 38% 35%,#F5A623,#E87F24);cursor:pointer;margin-top:-6.5px;border:2px solid rgba(254,253,223,0.90);box-shadow:0 2px 8px rgba(232,127,36,0.40);}
//     input[type="range"]::-moz-range-thumb{width:16px;height:16px;border-radius:50%;background:radial-gradient(circle at 38% 35%,#F5A623,#E87F24);cursor:pointer;border:2px solid rgba(254,253,223,0.90);box-shadow:0 2px 8px rgba(232,127,36,0.40);}
//     .right-panel{scrollbar-width:thin;scrollbar-color:rgba(232,127,36,0.40) rgba(232,127,36,0.08);}
//     ::-webkit-scrollbar{width:3px;height:3px;}
//     ::-webkit-scrollbar-track{background:rgba(232,127,36,0.06);border-radius:4px;}
//     ::-webkit-scrollbar-thumb{background:linear-gradient(180deg,#E87F24,#F5A623);border-radius:4px;}

//     .lens-carousel{display:flex;gap:14px;padding:6px 20px 14px;overflow-x:auto;overflow-y:visible;scroll-snap-type:x mandatory;-webkit-overflow-scrolling:touch;scrollbar-width:none;-ms-overflow-style:none;scroll-behavior:smooth;will-change:scroll-position;}
//     .lens-carousel::-webkit-scrollbar{display:none;}
//     .lens-ring{flex-shrink:0;scroll-snap-align:center;display:flex;flex-direction:column;align-items:center;gap:5px;cursor:pointer;user-select:none;-webkit-tap-highlight-color:transparent;transition:transform 0.25s ease;}
//     .lens-ring__circle{width:58px;height:58px;border-radius:50%;position:relative;display:flex;align-items:center;justify-content:center;background:radial-gradient(circle at 35% 35%,rgba(255,255,255,0.08),rgba(10,5,2,0.88));transition:transform 0.28s cubic-bezier(0.34,1.56,0.64,1),opacity 0.25s ease,box-shadow 0.28s ease;will-change:transform,opacity,box-shadow;}
//     .lens-ring__img{width:68%;height:68%;object-fit:contain;pointer-events:none;transition:filter 0.25s ease;}
//     .lens-ring--active .lens-ring__circle{transform:scale(1.15);box-shadow:0 0 0 2.5px #E87F24,0 0 0 5px rgba(232,127,36,0.20),0 0 24px rgba(232,127,36,0.55),0 0 44px rgba(245,166,35,0.18);}
//     .lens-ring--active .lens-ring__img{filter:drop-shadow(0 0 8px rgba(232,127,36,0.80)) brightness(1.05);}
//     .lens-ring--inactive .lens-ring__circle{transform:scale(0.88);opacity:0.55;box-shadow:0 0 0 1px rgba(255,255,255,0.12),0 2px 8px rgba(0,0,0,0.35);}
//     .lens-ring--inactive .lens-ring__img{filter:brightness(0.55) saturate(0.55);}
//     .lens-ring__circle:active{transform:scale(0.82)!important;transition:transform 0.10s ease!important;}
//     .lens-ring__glow-ring{position:absolute;inset:-3px;border-radius:50%;padding:2px;pointer-events:none;background:conic-gradient(from 0deg,#F5A623,#E87F24,#FF6B35,#F5A623);opacity:0;transition:opacity 0.25s ease;-webkit-mask:linear-gradient(#fff 0 0) content-box,linear-gradient(#fff 0 0);-webkit-mask-composite:xor;mask-composite:exclude;animation:spinRing 2s linear infinite;}
//     .lens-ring--active .lens-ring__glow-ring{opacity:1;}
//     @keyframes spinRing{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}
//     .lens-ring__label{font-size:9px;font-weight:700;letter-spacing:0.4px;text-align:center;max-width:64px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;transition:color 0.25s ease,opacity 0.25s ease;pointer-events:none;}
//     .lens-ring--active .lens-ring__label{color:#F5A623;opacity:1;}
//     .lens-ring--inactive .lens-ring__label{color:rgba(255,255,255,0.40);opacity:1;}
//     .lens-ring__dot{width:4px;height:4px;border-radius:50%;background:#E87F24;transition:opacity 0.25s ease,transform 0.25s ease;}
//     .lens-ring--active .lens-ring__dot{opacity:1;transform:scale(1);box-shadow:0 0 8px #E87F24;}
//     .lens-ring--inactive .lens-ring__dot{opacity:0;transform:scale(0);}
...
//     .spinner{width:44px;height:44px;border-radius:50%;border:2px solid rgba(115,165,202,0.20);border-top-color:#E87F24;animation:spin 0.85s linear infinite;}
//     .spinner-inner{width:30px;height:30px;border-radius:50%;border:1.5px solid rgba(232,127,36,0.15);border-bottom-color:#F5A623;animation:spin 1.2s linear infinite reverse;position:absolute;top:7px;left:7px;}
//     .ar-dot{width:7px;height:7px;border-radius:50%;background:#73A5CA;box-shadow:0 0 8px rgba(115,165,202,0.70);animation:pulse 2s ease infinite;display:inline-block;margin-right:6px;flex-shrink:0;}

//     /* ── "Viewing: [product name]" toast banner (desktop) ── */
//     .product-context-banner{
//       position:absolute;bottom:60px;left:50%;transform:translateX(-50%);
//       display:flex;align-items:center;gap:10px;
//       padding:7px 20px;border-radius:999px;
//       background:rgba(0,0,0,0.52);border:0.5px solid rgba(232,127,36,0.35);
//       white-space:nowrap;animation:fadeIn 0.35s ease;
...
//           <style>{css}</style>
//           <video ref={videoRef} style={{ position:"absolute", left:"-100%", top:"-100%", width:"1px", height:"1px", opacity:0, pointerEvents:"none" }} autoPlay playsInline muted />
//           <canvas ref={canvasRef} style={{ position:"absolute", inset:0, width:"100%", height:"100%", objectFit:"contain", display:"block", background:"black" }} aria-label="AR glasses try-on camera view" />
...
//           {/* ── "Viewing [product]" context banner for mobile ── */}
//           {incomingProductName && cameraReady && (
//             <div style={{ position:"absolute", top:18, left:"50%", transform:"translateX(-50%)", zIndex:25, display:"flex", alignItems:"center", gap:6, padding:"5px 14px", borderRadius:999, background:"rgba(0,0,0,0.50)", border:`1px solid ${C.primary25}`, whiteSpace:"nowrap", animation:"fadeIn 0.35s ease", pointerEvents:"none" }}>
//               <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#E87F24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z"/></svg>
//               <span style={{ fontSize:10, fontWeight:700, color:"rgba(254,253,223,0.90)", letterSpacing:"0.5px" }}>{incomingProductName}</span>
//             </div>
//           )}

//           {/* AR tracking indicator */}
//           {cameraReady && (
//             <div role="status" aria-live="polite" style={{ position:"absolute", top:92, left:16, zIndex:20, display:"flex", alignItems:"center", background:"rgba(0,0,0,0.42)", ...glassPill, border:`1px solid rgba(115,165,202,0.30)`, padding:"5px 12px", animation:"fadeIn 0.35s ease" }}>
//               <span className="ar-dot" aria-hidden="true" />
//               <span style={{ fontSize:10, fontWeight:600, color:"rgba(255,255,255,0.80)", letterSpacing:"0.5px" }}>Tracking</span>
//             </div>
//           )}
...
//           {/* Frame name + price */}
//           {cameraReady && currentGlass && (
//             <div aria-live="polite" style={{ position:"absolute", bottom:158, left:"50%", transform:"translateX(-50%)", zIndex:20, whiteSpace:"nowrap", background:"rgba(0,0,0,0.48)", ...glassPill, border:`1px solid ${C.primary25}`, padding:"7px 20px", display:"flex", alignItems:"center", gap:10, animation:"fadeIn 0.3s ease", boxShadow:`0 4px 20px rgba(0,0,0,0.25),0 0 20px ${C.primary12}` }}>
//               <span style={{ fontSize:13, fontWeight:700, color:"rgba(254,253,223,0.95)" }}>{currentGlass.name}</span>
//               <span aria-hidden="true" style={{ width:1, height:11, background:C.primary30, display:"inline-block" }} />
...
//             <div aria-hidden="true" style={{ position:"absolute", bottom:140, left:"50%", transform:"translateX(-50%)", display:"flex", gap:4, zIndex:20 }}>
//               {GLASS_OPTIONS.map((g, i) => (
//                 <div key={g.id} style={{ width: i===idx?14:4, height:4, borderRadius:3, background: i===idx?C.primary:C.white15, transition:"all 0.25s ease" }} />
//               ))}
//             </div>
//           )}

//           {/* Carousel */}
//           <div style={{ position:"absolute", bottom:0, left:0, right:0, zIndex:20, paddingBottom:"env(safe-area-inset-bottom,10px)", background:"linear-gradient(to top,rgba(8,4,1,0.97) 50%,rgba(8,4,1,0.80) 75%,transparent 100%)" }}>
//             <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 20px 2px" }}>
//               <span style={{ fontSize:9, fontWeight:700, letterSpacing:"2px", color:"rgba(254,253,223,0.30)", textTransform:"uppercase" }}>Frames</span>
//               <span style={{ fontSize:9, color:"rgba(254,253,223,0.25)" }} aria-live="polite">{idx+1} / {GLASS_OPTIONS.length}</span>
//             </div>
...
//               {GLASS_OPTIONS.map((g, i) => {
//                 const isA  = glasses === g.id;
//                 const size = isA ? CIRCLE_SIZE_ACTIVE : CIRCLE_SIZE_INACTIVE;
//                 return (
//                   <div
//                     key={g.id}
//                     ref={isA ? activeCarouselItemRef : null}  // ← ref for scroll-into-view
//                     className={`lens-ring ${isA ? "lens-ring--active" : "lens-ring--inactive"}`}
...
//                     style={{ minWidth: CIRCLE_SIZE_ACTIVE+2 }}
//                   >
//                     <div className="lens-ring__circle" style={{ width:size, height:size, background: isA?"radial-gradient(circle at 35% 35%,rgba(232,127,36,0.22),rgba(10,5,2,0.90))":"radial-gradient(circle at 35% 35%,rgba(255,255,255,0.07),rgba(10,5,2,0.82))" }}>
//                       <div className="lens-ring__glow-ring" aria-hidden="true" />
//                       <img src={g.id} alt={g.name} loading="lazy" className="lens-ring__img" />
//                     </div>
//                     <span className="lens-ring__label">{g.name}</span>
...
//             {/* ── "Viewing [product]" context banner for desktop ── */}
//             {incomingProductName && cameraReady && (
//               <div className="product-context-banner">
//                 <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#E87F24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z"/></svg>
//                 <span style={{ fontSize:11, fontWeight:700, color:"rgba(254,253,223,0.90)", letterSpacing:"0.5px" }}>Viewing: {incomingProductName}</span>
//               </div>
//             )}
...
//             <video ref={videoRef} style={{ position:"absolute", left:"-100%", top:"-100%", width:"1px", height:"1px", opacity:0, pointerEvents:"none" }} autoPlay playsInline muted />
//             <canvas ref={canvasRef} width={DESKTOP_CANVAS_W} height={DESKTOP_CANVAS_H} aria-label="AR glasses try-on camera view" style={{ display:"block", width:"100%", height:"100%", objectFit:"cover" }} />
...
//             {/* Show product context label in panel header */}
//             {incomingProductName && (
//               <div style={{ marginTop:8, display:"flex", alignItems:"center", gap:6, padding:"5px 10px", borderRadius:8, background:C.primary12, border:`1px solid ${C.primary25}` }}>
//                 <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke={C.primary} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z"/></svg>
//                 <span style={{ fontSize:9, fontWeight:700, color:C.primary, letterSpacing:"0.5px" }}>From: {incomingProductName}</span>
//               </div>
//             )}
//           </div>
...
// - Camera area takes remaining flex space
// - ASW badge + tracking overlayed on camera
// - Frames carousel at bottom
// -----------------------------------------------------------------------------
  ...
  if (isMobile) {
    ...
    return (
      <>
        ...
        {/* Main container: flex column, camera area takes remaining space */}
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
            minHeight: 'calc(100vh - 60px)', // adjust based on navbar height; fallback
            background: '#000',
            touchAction: 'pan-y',
          }}
          onTouchStart={onTouchStart}
          onTouchEnd={onTouchEnd}
        >
          {/* Camera area - flex grow 1, relative for overlays */}
          <div
            style={{
              position: 'relative',
              flex: '1 1 auto',
          ...
          >
            ...
            {/* Frame name + price overlay (bottom of camera area) */}
            {cameraReady && currentGlass && (
              <div
                aria-live="polite"
                style={{
                  ...
                  background: 'rgba(0,0,0,0.55)',
                  ...glassPill,
                  border: `1px solid rgba(232,127,36,0.35)`,
                  padding: '7px 20px',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 10,
                  animation: 'fadeIn 0.3s ease',
                  boxShadow: `0 4px 20px rgba(0,0,0,0.25),0 0 20px rgba(232,127,36,0.15)`,
                }}
              >
                <span style={{ fontSize: 13, fontWeight: 700, color: 'rgba(254,253,223,0.95)' }}>{currentGlass.name}</span>
                <span aria-hidden="true" style={{ width: 1, height: 11, background: 'rgba(232,127,36,0.40)', display: 'inline-block' }} />
                <span style={{ fontSize: 13, fontWeight: 700, background: 'linear-gradient(135deg, #F5A623, #E87F24)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{currentGlass.price}</span>
              </div>
            )}

            {/* Product context banner when coming from product page */}
            {incomingProductName && cameraReady && (
              <div
                style={{
                  position: 'absolute',
            ...
            {/* Progress dots - centered at bottom of camera area */}
            {cameraReady && (
              <div
                aria-hidden="true"
                style={{
                ...
                {GLASS_OPTIONS.map((g, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: 4,
                      borderRadius: 3,
                      background: i === idx ? '#E87F24' : 'rgba(255,255,255,0.25)',
                      transition: 'all 0.25s ease',
                    }}
                  />
                ))}
            ...
            {!cameraReady && (
              <div
                ...
                style={{
                  ...
                  inset: 0,
                  zIndex: 50,
                  background: 'radial-gradient(ellipse 120% 80% at 55% 30%,rgba(232,127,36,0.08) 0%,rgba(0,0,0,0.98) 60%)',
                  display: 'flex',
                  flexDirection: 'column',
                  alignItems: 'center',
                ...
                <div style={{ textAlign: 'center' }}>
                  <div
                    style={{
                      ...
                      fontWeight: 800,
                      marginBottom: 6,
                      background: 'linear-gradient(135deg, #F5A623, #E87F24)',
          ...
          {/* Frames carousel - fixed at bottom */}
          <div
            style={{
              flexShrink: 0,
              paddingBottom: 'env(safe-area-inset-bottom,10px)',
              background: 'linear-gradient(to top,rgba(8,4,1,0.98) 40%,rgba(8,4,1,0.80) 70%,transparent 100%)',
            }}
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 20px 2px' }}>
            ...
            <div className="lens-carousel" role="listbox" aria-label="Select glasses frame">
              {GLASS_OPTIONS.map((g, i) => {
                ...
                return (
                  <div
                    key={g.id}
                    ref={isA ? activeCarouselItemRef : null}
                    className={`lens-ring ${isA ? 'lens-ring--active' : 'lens-ring--inactive'}`}
                    role="option"
                    aria-selected={isA}
                    tabIndex={0}
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        height: size,
                        background: isA
                          ? 'radial-gradient(circle at 35% 35%,rgba(232,127,36,0.28),rgba(10,5,2,0.95))'
                          : 'radial-gradient(circle at 35% 35%,rgba(255,255,255,0.07),rgba(10,5,2,0.85))',
                      }}
                    >
                      <div className="lens-ring__glow-ring" aria-hidden="true" />
                      <img src={g.id} alt={g.name} loading="lazy" className="lens-ring__img" />
          ...
          <div role="listbox" aria-label="Select glasses frame" style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:8 }}>
            {GLASS_OPTIONS.map(g => {
              ...
              return (
                <div
                  key={g.id}
                  ref={isA ? activeGridItemRef : null}
                  className="frame-card"
                  role="option" aria-selected={isA} tabIndex={0}
                  onClick={() => setGlasses(g.id)}
                  onKeyDown={e => (e.key==="Enter"||e.key===" ") && setGlasses(g.id)}
